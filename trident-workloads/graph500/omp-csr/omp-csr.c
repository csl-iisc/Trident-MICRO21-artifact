...
static int64_t * restrict vlist = NULL;
...
alloc_graph (int64_t nedge)
{
  ...
  printf("Allocate Graph: xoff\n");
  xoff = xmalloc_large_ext (sz);
  if (!xoff) return -1;
  printf("Allocate Graph: vlist\n");
